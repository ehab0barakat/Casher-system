@props(['id', 'name', 'url', "description" ,  'editAction', 'deleteAction'])
<div
    ...
    <div class="flex items-center gap-4">
        ...
        <div class="flex flex-col items-start justify-center gap-2">
            ...
            <span class="text-base lg:text-lg 2xl:text-xl font-roboto-m">{{ $name }}</span>

            <span class="text-sm lg:text-base 2xl:text-lg font-roboto">
                <span class="font-roboto-b">{{ __('fields.description-label') }}</span>
                {{ $description }}
            </span>
